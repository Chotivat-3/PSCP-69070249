...
จากโจทย์ รับ input เข้ามาเป็น อักขระที่มีความยาว 5 ตัวอักษร และ output ส่งออกเป็น เปลี่ยนลำดับการเรียงจากหลังไปหน้าแทน [abcde --> edcba]   
จากตอนแรกผมอ่านถึงเท่านี้และเริ่มทำ ทว่ายังผิดพลาดจากการอ่านโ๗ทย์ไม่ครบ เนื่องจากโจทย์บอกว่า ควรเปลี่ยนเป็นตัวอักษรพิมพ์เล็ก!!!
# 3. วิธีแรก  
